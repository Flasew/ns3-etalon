...
CC = ['/usr/bin/gcc']
CCDEFINES = ['NDEBUG']
CCFLAGS = ['-O3', '-g0', '-Wall', '-Werror', '-O3', '-g0', '-Wall', '-Werror', '-fomit-frame-pointer', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES = ['NDEBUG']
CXXFLAGS = ['-O3', '-g0', '-Wall', '-Werror', '-fomit-frame-pointer', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
DEFINES = ['NS3_BUILD_PROFILE_RELEASE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_IF_TUN_H=1']
...
EXAMPLE_DIRECTORIES = ['udp', 'tcp', 'wireless', 'traffic-control', 'realtime', 'socket', 'matrix-topology', 'tutorial', 'routing', 'naming', 'stats', 'ipv6', 'error-model', 'udp-client-server', 'energy']
...
VERSION = '3.29'
WITH_PYBINDGEN = '/home/wew168/ns1/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/wew168/ns1/ns-3.29/build/ns3/config-store-config.h', '/home/wew168/ns1/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
